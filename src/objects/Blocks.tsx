import _Food from "./Food";
import _FoodPackage from "./FoodPackage";
import _Bomb from "./Bomb";
...
export namespace Blocks {
    ...
    export class Candy extends _Candy {}
    export class Snickers extends _Snickers {}
}
